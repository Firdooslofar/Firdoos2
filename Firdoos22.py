#coding=utf-8
#!/usr/bin/python2
#Originally Written By Firdoos lofar
try:
    import os,sys,time,datetime,re,random,hashlib,threading,json,getpass,urllib,cookielib,requests
    from multiprocessing.pool import ThreadPool
except ImportError:
    os.system("pip2 install requests")
    os.system("python2 Firdoos22.py")
os.system("clear")
"""
try:
    my = requests.get("https://muhammad.Firdoos.5214")
...
#MyLogo
def logo():
    os.system('echo -e "██████╗░░█████╗░███╗░░██╗░█████╗░\n██╔══██╗██╔══██╗████╗░██║██╔══██╗\n██████╔╝███████║██╔██╗██║███████║\n██╔══██╗██╔══██║██║╚████║██╔══██║ \n██║░░██║██║░░██║██║░╚███║██║░░██║\n\n-----------------------------------------------\n\n➣ Codded By : Firdooslofar\n➣ Facebook  : muhammad.firdoos.5214\n➣ Github    : https://github.com/Firdooslofar5214\n➣ Whatsap   : 0596360692\n\n-----------------------------------------------" | lolcat')
def method_menu():
    os.system("clear")
    logo()
    print("")
